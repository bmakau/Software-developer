      ...
      <div>
        <Grid>
          <Cell col={4}>
            ...
            <p>Skilled in both frontend and backend development. Front end development technologies include HTML, CSS, Javascript,
            react js, redux and LESS. The backend development skills are Python, Java, Django, Spring, Express, Mongoose, MySQL,
            and Node Js.
            </p>
            <hr style={{borderTop: '3px solid #833fb2', width: '50%'}}/>
